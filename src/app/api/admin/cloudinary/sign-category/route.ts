...
import { getCategoryFolder } from "@/lib/cloudinary";
...
export async function POST(request: Request) {
  try {
    ...
    const body = z.object({ categoryId: guidSchema }).parse(await request.json());
    ...
    const folder = getCategoryFolder(body.categoryId);
